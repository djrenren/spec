...
let eq_of = function
  ...
  | HandleType -> assert false (* I have no idea where this is used *)

let and_of = function
  | I32Type | F32Type -> Values.I32 I32Op.And
  | I64Type | F64Type | HandleType -> Values.I64 I64Op.And

let reinterpret_of = function
  | I32Type -> I32Type, Nop
  | I64Type -> I64Type, Nop
  | HandleType -> HandleType, Nop
...
let canonical_nan_of = function
  ...
  | I64Type | F64Type | HandleType -> Values.I64 (F64.to_bits F64.pos_nan)


let abs_mask_of = function
  | I32Type | F32Type -> Values.I32 Int32.max_int
  | I64Type | F64Type | HandleType -> Values.I64 Int64.max_int
...
let is_js_value_type = function
  | I32Type -> true
  | I64Type | F32Type | F64Type | HandleType -> false
...
let of_literal lit =
  ...
  | Values.Handle _ -> assert false (* no literal handles *)
