...
type ('i32, 'i64, 'f32, 'f64, 'handle) op =
  I32 of 'i32 | I64 of 'i64 | F32 of 'f32 | F64 of 'f64 | Handle of 'handle

type value = (I32.t, I64.t, F32.t, F64.t, Handle.t) op
